...
1. I have setup neovim clipboard for wayland using wl-clipboard. X users have to get rid of lines 60-69 (inclusive) from the init.vim file which defines the clipboard setup for wayland. X users may instead use the equivalent X clipboard setup offered by their respective linux distributions. 
